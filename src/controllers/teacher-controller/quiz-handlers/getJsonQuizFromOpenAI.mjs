import { saveQuizJson } from './saveQuizJson.js';
...
const getJsonQuizFromOpenAI = async (jsonData, numQuestions, numAnswers, baseFileName) => {
    let attempt = 0;
    let validResponse = false;
    let result = null;

    // Încercăm de mai multe ori să obținem un răspuns valid de la OpenAI
